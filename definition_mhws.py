...
year_to_plot = slice(20,24) #last idx excluded
eta_rho_to_plot = 200 
xi_rho_to_plot = 1000  
...
# Avg over time - 1 value per year
mhw_event_avg_to_plot =  ds_mhw_duration_stacked.mean(dim=['days','eta_rho', 'xi_rho']).mhw_duration 
...
# ax.plot(non_mhw_duration_before_to_plot, label="Non-MHW", color='#A2B36B',linestyle=":")
# ax.plot(mhw_duration_before_to_plot, label="MHW", color='#DC6D04', linestyle="--")
ax.plot(mhw_event_avg_to_plot, label="Extended MHW", color='#780000', linestyle="-")
