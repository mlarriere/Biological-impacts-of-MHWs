...
from B_Growth_Model.Atkinson2006_model import *  # import growth function
...
simulated_length_study_area = length_Atkinson2006(chla=chla_surf_1season.raw_chla, temp=temp_avg_100m_1season.avg_temp, initial_length=35, intermoult_period= 10)
