...
climatological_length = length_Atkinson2006(chla=chla_clim_mean.chla, 
...
# == Climatological Length
climatological_length = length_Atkinson2006(chla=chla_clim_atl_mean.chla, temp=temp_clim_atl_mean.avg_temp, initial_length=35, intermoult_period=10)

# == Length for 1 year (3years with most MHWs)
length_mhw_yr0 = length_Atkinson2006(chla=chla_surf_study_area_allyrs.chla.isel(years=selected_years_idx[0]), 
                                   temp=temp_avg_100m_study_area_allyrs.avg_temp.isel(years=selected_years_idx[0]), 
                                   initial_length=35, intermoult_period=10)
length_mhw_yr1 = length_Atkinson2006(chla=chla_surf_study_area_allyrs.chla.isel(years=selected_years_idx[1]), 
                                   temp=temp_avg_100m_study_area_allyrs.avg_temp.isel(years=selected_years_idx[1]), 
                                   initial_length=35, intermoult_period=10)
length_mhw_yr2 = length_Atkinson2006(chla=chla_surf_study_area_allyrs.chla.isel(years=selected_years_idx[2]), 
