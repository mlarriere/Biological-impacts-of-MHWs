...
ds_mhw_duration= xr.Dataset(
    ...
    coords=dict(
        ...
        days=(['days'], mhw_duration_5m_NEW_60S_south.coords['days'].values), # Keeping information on day 
...
# %% Select only 1 year of interest (1st attempt) -- 2018-2019
