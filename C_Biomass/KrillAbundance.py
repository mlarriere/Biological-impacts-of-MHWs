...
# --- Output handling ---
outdir = os.path.join(os.getcwd(), 'Biomass/figures_outputs/Abundance')
...
if plot == 'report':
    ...
    # plt.savefig(os.path.join(os.getcwd(), f'Biomass/figures_outputs/Abundance/abundance_distribution_{plot}.png'), dpi=500, format='png', bbox_inches='tight')
    plt.show()
...
if plot == 'report':
    ...
    # plt.savefig(os.path.join(os.getcwd(), f'Biomass/figures_outputs/Abundance/high_abundance_{plot}.png'), dpi=500, format='png', bbox_inches='tight')
    plt.show()
